            ...
            <div class="">
                @if (Auth::user()->avatar == null)
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('Dashboard/img/profile/user_icon.png') }}"><span
                        class="avatar-status profile-status bg-green"></span>
                @else
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('Dashboard/img/profile/Admin/' . Auth::user()->id . '/' . Auth::user()->avatar) }}"><span
                        class="avatar-status profile-status bg-green"></span>
                @endif
            </div>
            <div class="user-info">
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a class="slide-item" href="{{ route('appointments.index3') }}">قائمة المواعيد المنتهية</a>
                </li>
            </ul>
        </li>
