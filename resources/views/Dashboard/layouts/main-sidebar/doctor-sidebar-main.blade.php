        ...
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                    ...
                    @else
                        <img alt="user-img" class="avatar avatar-xl brround"
                            src="{{ URL::asset('Dashboard/img/profile/Doctor/' . Auth::user()->id . '/' . Auth::user()->avatar) }}"><span
                            class="avatar-status profile-status bg-green"></span>
                    @endif
                </div>
                <div class="user-info">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('chat.patients') }}">قائمة المحادثات الاخيرة</a></li>
                </ul>
            </li>
        </ul>
    </div>
