                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content border-left border-bottom border-right border-top-0 p-4">
                                <div class="tab-pane active" id="settings">
                                    <form action="{{ route('ProfileLaboratorie.update', $info->id) }}" method="POST">
                                        {{ csrf_field() }}
    ...
    <div class="modal fade" id="photo_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action='{{ route('AddimageLaboratorie.update') }}' method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        ...
                        @else
                            <input type="file" name="photo" class="dropify"
                                accept=".pdf,.jpg, .png, image/jpeg, image/png"
                                data-default-file="{{ URL::asset('Dashboard/img/profile/Admin/' . Auth::user()->id . '/' . Auth::user()->avatar) }}"
                                data-height="100" />
                        @endif
